...
pub enum ZedRemoteError {
    ...
    #[error("Cannot read Codey Zed remote project registry")]
    RegistryRead(#[source] std::io::Error),
    #[error("Cannot parse Codey Zed remote project registry")]
    RegistryParse(#[source] serde_json::Error),
    #[error("Cannot write Codey Zed remote project registry")]
