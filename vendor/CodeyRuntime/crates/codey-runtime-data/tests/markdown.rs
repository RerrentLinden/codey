use codey_runtime_core::models::{ExportStatus, SessionRef};
use codey_runtime_data::MarkdownExportService;
...
fn markdown_exporter_searches_candidate_databases() {
    ...
    let result = codey_runtime_data::export_markdown_from_paths(
