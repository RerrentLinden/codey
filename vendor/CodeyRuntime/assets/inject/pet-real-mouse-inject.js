(() => {
  ...
  const existing = window.__codeyPetRealMouseLook;
  ...
  function stop() {
    ...
    unsubscribe?.();
    if (window.__codeyPetRealMouseLook?.version === runtimeVersion) {
      delete window.__codeyPetRealMouseLook;
    }
  }
  ...
  window.__codeyPetRealMouseLook = runtime;
})();
